...
func _physics_process(delta:float) ->void:
	...
	if get_child_count() > 0:
		...
		match type:
			...
			_:
				Game.body_equipped = load("res://Scenes/player/GUI/Inventory/default stats/default_body_armor.tres")
				Game.right_hand_equipped= load("res://Scenes/player/GUI/Inventory/default stats/default_sword.tres")
